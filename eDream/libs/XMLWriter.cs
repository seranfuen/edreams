...
namespace eDream.libs
{
    ...
    internal class XMLWriter : IDisposable
    {
        ...
        private XmlTextWriter XMLSaver;
        ...
        public bool ParseEntries(string fileName, IEnumerable<DreamEntry> dreamList)
        {
            var valid = true;
            try
            {
        ...
        {
            if (XMLSaver == null) throw new Exception("Null XMLSaver object");
        ...
        {
            if (XMLSaver == null || dreamList == null) throw new Exception("Null XMLSaver object or null tagList");
            foreach (var entry in dreamList.Where(dream => !dream.ToDelete))
            {
